...
Kaggle competition daily for "HuBMAP + HPA - Hacking the Human Body." <br>
...
### description
5つのヒト臓器の機能的組織単位（FTU: functional tissue units）を特定・segmentationすることが目的．
FTU：臓器の主な生理的機能を果たす細胞集団．
...
実際のところ，このことはモデル構築と汎化に際してどこまで問題となるのだろうか？<br><br>
